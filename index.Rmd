...
We then examine the combined natural disaster dataset via an aggregate table shown below, sorted from highest to lowest, descending order, by the difference in economic damage.

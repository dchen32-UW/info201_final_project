...
# cleans temperature by country data, note unlike the midpoint deliverable
#   version we assume that the provided virgin islands is the correct one
#   and do not rename the british virgin islands as virgin islands
# parameters:
